...
describe("GET /companies", function() {
  ...
  /////////
  test("query params search: minEmployees", async function() {
  ...
  test("query params search: maxEmployees", async function() {
  ...
  test("query params search: name", async function() {
  ...
  test("query params search: all", async function() {
  ...
  test("query params search: invalid query", async function() {
    const resp = await request(app)
    .get("/companies")
    .query({ minEmployees: "test", maxEmployees: 2, name: "c" });
    expect(resp.statusCode).toEqual(400);
  }); //////
});
